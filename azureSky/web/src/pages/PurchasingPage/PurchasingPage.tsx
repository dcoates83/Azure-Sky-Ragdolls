  ...
  return (
    <>
      ...
      <section id="purchasing">
        <div className="container-text">
          ...
          <p>
            ...
            if you run that information by us about other kittens being sold. We
            do not mind giving you feedback.
          </p>
          <p>
          ...
          <h3>
            The <span className="italic">scary</span> part! Making a Deposit to
            Reserve a Kitten
          </h3>
          <p>
            <span className="underline">
            ...
            Your deposit is <span className="bold">guaranteed</span> to get you
            a kitten. You may pass on a litter and wait for another litter to
            get the kitten you want. Despite concerns about whether they get a
      ...
      <section id="guarantee">
        <div className="container-text">
          <header>
            <h1 className="header-2">What does my Ragdoll kitten come with?</h1>
          </header>
            ...
            <div className="guarantee-grid-list">
              <ul className="going-home">
                ...
                <li>
                  ...
                  <span className="bold">Ongoing support</span> for the life of
                  your cat
                </li>
                <li>
                  <svg
      ...
      <section id="pick-up">
        <div className="container-text">
          ...
          <p>
            All our kittens are
            <strong>examined thoroughly a minimum of 2x </strong>by our current
            veterinarian Dr Diane McKelvey; a
            <strong>certified Feline Specialist.</strong> Kind, caring and truly
            knowledgeable; we are extremely glad to have her. She won BCSPCA
            veterinarian of the year in 2016.
          </p>
          <h4>Deworming:</h4>
          <p>
            Deworming is done
            <strong>every 10 to 14 days 3x after week 6</strong> based on their
            weight: <strong>then monthly</strong>. All cats require regular
            worming. Once your kitten is home, we recommend worming medications
            purchased from your veterinarian as not all over the counter wormers
            cover all types of worms.
            <em>Even though your cat is an indoor cat, they require worming</em>
            as worm eggs can be brought into the house on owners’ shoes or other
            pet’s feet. Always follow your veterinarian’s advice. Wormers, flea,
            and tick medication can be lethal if administered incorrectly.
          </p>
          <h4>Vaccinations:</h4>
          <p>
          ...
          <p>
            ...
            <em>make them comfortable being in their crate</em>. You may buy one
            of our crates for your kitten if you need.
          </p>
          <h4>Food:</h4>
          <p>
          ...
          <p>
            The socialization that we do, before they are 2 months old and go to
            your home, is extremely important to having a well- balanced, happy
            kitten. We handle the kittens daily!
          </p>
          ...
          <p>
            As you wait for your kitten to come home, we keep you updated on the
            progress of your kitten. We appreciate your patience in not taking
            the kittens too early, and we understand you do not want to miss out
            on any of their babyhood.
          </p>
          <h2>The best day! Picking up your kitten</h2>
          <h4>Kittens go home!</h4>
          <p>We arrange a mutually agreeable pick-up time, date, and place.</p>
          <p>
            We try to connect owners with other people going the same direction
          ...
          <form action="https://submit-form.com/AqUcFuf1" method="" id="form">
            ...
            <div className="input-grid">
              <div className="email-help">
                We'll <span className="underline">never</span> share your
                information with anyone else.
              </div>
              <div className="email-help">
                We need verifiable info to prove that you are a person, and not
                a cat mill.
              </div>
            </div>
